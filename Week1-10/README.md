...
## วิธีใช้งานแต่ละสัปดาห์ (Quick Start)

### Week 1: TCP Client-Server (Unicast)
1. แก้ไข `config.py` (HOST, PORT, BUFFER_SIZE) ให้เหมาะสม
...
> **หมายเหตุ:**
> - ถ้าทดลองบนเครื่องเดียว (localhost) สามารถใช้ config ตัวอย่างได้เลย
> - ถ้ารันข้ามเครื่อง/ข้าม network ให้เปลี่ยน HOST/IP ให้ตรงกับ network จริง
> - ถ้าเจอ error หรือปัญหา network แจ้งรายละเอียดเพื่อขอคำแนะนำเพิ่มเติมได้ทันที
